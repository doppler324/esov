...
$APPLICATION->SetPageProperty("keywords", "Часы купить #SOTBIT_REGIONS_UF_PRED#");
$APPLICATION->SetPageProperty("description", "Часы купить");
$APPLICATION->SetTitle("Часы купить #SOTBIT_REGIONS_UF_PRED# - низкие цены, быстрая доставка - интернет-магазин ВекЧасов.рф");?>
<?/* 
	//include module
...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"PICTURE_WIDTH" => "220",
		"PICTURE_HEIGHT" => "200",
		"PROP_VALUE" => array(0 => "31008",1 => "31009",2 => "31010",3 => "31011",4 => "31012",),
		"ELEMENTS_COUNT" => "10",
