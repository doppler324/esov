													...
													<ul class="nextColumn">
														<?foreach ($next2Column as $x2 => $next2Element):?>
															<li<?if(!empty($next2Element["ELEMENTS"])):?> class="allow-dropdown"<?endif;?>>
																...
																<?endif;?>
																<a href="<?=($next2Element["LINK"] ? $next2Element["LINK"] : "javascript:void(0);")?>" class="menu2Link<?if ($next2Element["SELECTED"]):?> selected<?endif?>">
																	<?=$next2Element["TEXT"]?>
																...
																<?if(!empty($next2Element["ELEMENTS"])):?>
																	<ul>
																		<?foreach($next2Element["ELEMENTS"] as $x3 => $next3Element):?>
																			<li>
																				<a href="<?=($next3Element["LINK"]  ? $next3Element["LINK"] : "javascript:void(0);")?>" class="menu2Link<?if ($next3Element["SELECTED"]):?> selected<?endif?>">
																					<?=$next3Element["TEXT"]?>
																				</a>
																			</li>
																		<?endforeach;?>
