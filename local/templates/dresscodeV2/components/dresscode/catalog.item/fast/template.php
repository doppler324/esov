			...
			<div class="appFastViewColumnContainer">
				...
				<div class="appFastViewInformationColumn">
					...
					<?else:?>
						...
						<a target="_blank" href="/red.php?red=<?=urlencode($arResult["PARTNER_LINK"] . '?subid=sect_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="addCart" data-id="<?=$arResult["ID"]?>"><img src="<?=SITE_TEMPLATE_PATH?>/images/request.png" alt="" class="icon">Узнать цену</a>
					<?endif;?>
