		...
		<div class="tabloid nowp">
		    ...
		    <div class="productTable">
		    	...
		    	<div class="productColText">
					<a href="<?=$arResult["DETAIL_PAGE_URL"]?>" class="name"><span class="middle"><?= (IS_FILTER ? $APPLICATION->ShowViewContent('sotbit_seometa_bread') . " " .  $arResult["NAME"] : $arResult["NAME"])  ?></span></a>					
			...
			<div class="optional">
				<div class="row">
					<a 
						onclick="ym(<?=$arTemplateSettings['TEMPLATE_METRICA_ID']?>,'reachGoal','<?=$arTemplateSettings['TEMPLATE_METRICA_ADD_CART']?>');"
						target="_blank"
						href="/red.php?red=<?=urlencode($arResult["PARTNER_LINK"] . '?subid=section' . '&subid1=' . $arResult['ID']. '&subid2=' . $SESSION . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" 
						class="fastBack label<?if(empty($arResult["PRICE"]) || $arResult["CATALOG_AVAILABLE"] != "Y"):?> disabled<?endif;?>"
