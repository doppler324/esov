			...
			<div class="addCartContainer">
				<?if(!empty($arResult["PRICE"])):?>
					<?if($arResult["CATALOG_AVAILABLE"] != "Y"):?>
						...
						<?endif;?>
					<?else:?>
						<a onclick="ym(<?=$arTemplateSettings['TEMPLATE_METRICA_ID']?>,'reachGoal','<?=$arTemplateSettings['TEMPLATE_METRICA_ADD_CART']?>');" target="_blank" href="/red.php?red=<?=urlencode($arResult["PARTNER_LINK"] . '?subid=elem_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="addCart changeID changeQty changeCart" data-id="<?=$arResult["ID"]?>"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/incart.png" alt="<?=GetMessage("ADDCART_LABEL")?>" class="icon">Подробнее</span></a>
					<?endif;?>
				<?else:?>
					<a onclick="ym(<?=$arTemplateSettings['TEMPLATE_METRICA_ID']?>,'reachGoal','<?=$arTemplateSettings['TEMPLATE_METRICA_ADD_CART']?>');" target="_blank" href="/red.php?red=<?=urlencode($arResult["PARTNER_LINK"] . '?subid=elem_' . $arResult['ID'] . '&ulp=' . $arResult['PROPERTIES']['URL_PRODUCT']['VALUE'])?>" class="addCart changeID changeQty changeCart"><span><img src="<?=SITE_TEMPLATE_PATH?>/images/request.png" alt="<?=GetMessage("REQUEST_PRICE_BUTTON_LABEL")?>" class="icon">Подробнее</span></a>
				<?endif;?>				
			</div>
